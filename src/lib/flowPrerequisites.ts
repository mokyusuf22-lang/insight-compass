...
const FLOW_STEPS: { route: string; requires: (keyof FlowProgress)[]; label: string }[] = [
  ...
  { route: '/goals-reality', requires: [], label: 'Current Challenges & Barriers' },
  { route: '/assessment/wheel-of-life', requires: [], label: 'Wheel of Life Assessment' },
  { route: '/assessment/blob-tree', requires: [], label: 'Blob Tree Assessment' },
  { route: '/assessment/value-map', requires: [], label: 'Value Map Assessment' },
